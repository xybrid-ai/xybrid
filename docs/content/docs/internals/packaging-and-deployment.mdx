...
- [Observability](/docs/internals/observability) - Monitor deployed pipelines
- [Registry](/docs/internals/registry) - Registry architecture details
- [Bundles](/docs/internals/bundles) - Bundle format specification
