...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   Microphone ─────▶ AudioBuffer ─────▶ Chunking ─────▶ Model ─────▶ Partial │
│                          │                                   │     Results  │
│                          │                                   │              │
│                     [overlap]                           [callback]          │
│                                                                             │
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   idle ─────▶ streaming ─────▶ finalizing ─────▶ completed                 │
│     │              │                                    │                   │
│     │              │                                    │                   │
│     └──────────────┴────────────▶ error ◀──────────────┘                   │
│                                                                             │
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                      Orchestrator (Streaming Mode)                          │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   1. push_stream_chunk(envelope, is_last)                                   │
│         │                                                                   │
│         ▼                                                                   │
│   2. StreamManager queues chunk                                             │
│         │                                                                   │
│         ▼                                                                   │
│   3. execute_streaming_stage() processes when ready                         │
│         │                                                                   │
│         ▼                                                                   │
│   4. pop_stream_output() retrieves results                                  │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
