...
<Cards>
  <Card title="Envelope" href="/docs/overview/envelope" description="The universal data container" />
  <Card title="Orchestrator" href="/docs/overview/orchestrator" description="Policy evaluation and routing" />
  <Card title="Pipeline" href="/docs/overview/pipeline" description="Multi-stage workflow definition" />
  <Card title="TemplateExecutor" href="/docs/overview/executor" description="Model execution engine" />
  <Card title="StreamSession" href="/docs/overview/stream-session" description="Real-time audio processing" />
</Cards>
