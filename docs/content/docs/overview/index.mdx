...
<Cards>
  <Card title="Quick Start" href="/docs/overview/quickstart" description="Get up and running in minutes" />
  <Card title="How It Works" href="/docs/overview/architecture" description="Understand the data flow and execution model" />
  <Card title="Core Components" href="/docs/overview/envelope" description="Deep dive into Envelope, Pipeline, Orchestrator" />
</Cards>
