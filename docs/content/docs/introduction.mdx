...
| Web (browser) | @xybrid/web (private preview) |
...
<Cards>
  ...
  <Card title="Flutter SDK" href="/docs/sdks/flutter" description="Flutter integration guide" />
  <Card title="Unity SDK" href="/docs/sdks/unity" description="Unity integration guide" />
  <Card title="iOS SDK" href="/docs/sdks/ios" description="Native iOS/macOS integration" />
</Cards>
