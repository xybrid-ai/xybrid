...
and discards the audio. Voice-activity detection cuts chunks on speech
boundaries instead of a fixed clock, which avoids the stutter you get when a
window lands mid-word.
