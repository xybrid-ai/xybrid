...
/// Convert GenerationConfigData over a caller-provided SDK GenerationConfig.
fn generation_config_data_to_sdk(
...
pub unsafe extern "C" fn xybrid_model_run(
    ...
    let result = panic::catch_unwind(AssertUnwindSafe(|| {
        ...
        let sdk_config = if config.is_null() {
            ...
            XybridGenerationConfigHandle::as_ref(config).map(|data| {
                generation_config_data_to_sdk(data, model_state.model.default_generation_config())
            })
        };
...
mod tests {
    ...
    #[test]
    fn generation_config_data_applies_over_base() {
        let data = GenerationConfigData {
            max_tokens: None,
            temperature: None,
            top_p: None,
            min_p: None,
        ...
        let config = generation_config_data_to_sdk(&data, base);
