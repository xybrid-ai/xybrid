...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2113297335;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        38 => wire__crate__api__model__FfiModel_supports_token_streaming_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        48 => wire__crate__api__device__XybridDevice_apply_debug_memory_pressure_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        49 => wire__crate__api__device__XybridDevice_clear_battery_level_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        50 => wire__crate__api__device__XybridDevice_clear_debug_memory_pressure_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        51 => wire__crate__api__device__XybridDevice_clear_thermal_state_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        52 => wire__crate__api__device__XybridDevice_current_snapshot_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        53 => wire__crate__api__device__XybridDevice_set_battery_level_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        54 => wire__crate__api__device__XybridDevice_set_thermal_state_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__sdk_client__XybridSdkClient_configure_platform_telemetry_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__api__sdk_client__XybridSdkClient_flush_platform_telemetry_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__sdk_client__XybridSdkClient_init_sdk_cache_dir_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__sdk_client__XybridSdkClient_init_telemetry_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__api__sdk_client__XybridSdkClient_is_model_cached_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        60 => wire__crate__api__sdk_client__XybridSdkClient_is_telemetry_initialized_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        61 => wire__crate__api__sdk_client__XybridSdkClient_runtime_features_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        62 => wire__crate__api__sdk_client__XybridSdkClient_set_api_key_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        63 => wire__crate__api__sdk_client__XybridSdkClient_set_gateway_url_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__api__model__ffi_generation_config_creative_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        66 => wire__crate__api__model__json_schema_to_gbnf_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
