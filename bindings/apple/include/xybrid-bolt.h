...
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_model_stream(uint64_t receiver, const uint8_t *config_ptr, uintptr_t config_len, uint64_t *return_out);
...
void boltffi_release_class_xybrid_bolt_xybrid_asr_stream_session(uint64_t handle);
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_asr_stream_session_feed(uint64_t receiver, const float *samples_ptr, uintptr_t samples_len);
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_asr_stream_session_next(uint64_t receiver, FfiBuf_u8 *return_out);
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_asr_stream_session_flush(uint64_t receiver, FfiBuf_u8 *return_out);
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_asr_stream_session_reset(uint64_t receiver);
FfiBuf_u8 boltffi_method_class_xybrid_bolt_xybrid_asr_stream_session_stop(uint64_t receiver);
