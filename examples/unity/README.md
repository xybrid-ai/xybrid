# Xybrid Unity Example

A Unity project demonstrating Xybrid SDK integration for on-device ML inference in games.
...
2. Copy the library:
   ```bash
   cp target/release/libxybrid_ffi.dylib examples/unity/Assets/Plugins/macOS/libxybrid.dylib
   ```
